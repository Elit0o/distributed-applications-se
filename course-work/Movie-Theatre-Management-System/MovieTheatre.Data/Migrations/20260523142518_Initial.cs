        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HallNum = table.Column<byte>(type: "tinyint", nullable: false),
                    SeatsCount = table.Column<int>(type: "int", nullable: false),
                    Is3D = table.Column<bool>(type: "bit", nullable: false),
                    SoundSystem = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birthday", "CreatedOn", "FName", "IsAdmin", "LName", "PasswordHash", "UpdatedOn", "Username" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2003, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin", true, "admin", "admin", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin" });
